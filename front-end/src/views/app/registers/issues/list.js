...
class ListPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      orderOptions: [
        { column: "code", label: "Issue #" },
        { column: "typeId", label: "Type" },
        { column: "priorityId", label: "Priority" },
        { column: "statusId", label: "Status" },
        { column: "workstreamId", label: "Workstream" },
        { column: "actionActualProgress", label: "Action Progress" }
      ],
      selectedOrderOption: { column: "code", label: "Issue #" },
